...
#define __GMP_CC "gcc"
#define __GMP_CFLAGS "-s -O2 -fPIC  -O2 -DSQLITE_HAVE_ISNAN -fno-math-errno -funsafe-math-optimizations -fno-signed-zeros -fno-trapping-math -ffinite-math-only -fno-rounding-math -fno-signaling-nans -ftree-vectorize -fomit-frame-pointer -funswitch-loops -fivopts -m32 -arch i386 -fomit-frame-pointer -mmacosx-version-min=10.5 -Qunused-arguments -Wno-error=unused-command-line-argument-hard-error-in-future -DNO_ASM"
